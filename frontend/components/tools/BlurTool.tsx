...
export default function BlurTool({ onBlurChange }: BlurToolProps) {
    ...
    <View style={styles.container}>
      <View style={styles.section}>
        <View style={styles.labelRow}>
          ...
          <Text style={styles.value}>{Math.round(blurIntensity)}px</Text>
        </View>
        <Slider
          style={styles.slider}
          minimumValue={0}
      ...
      <View style={styles.infoBox}>
        ...
        <Text style={styles.infoText}>
          Slide to add blur effect to the image
        </Text>
      </View>
    </View>
  );
